...
func (a *api) apiV1Routes(mux *http.ServeMux) {
	...
	mux.HandleFunc("PATCH /api/v1/layers/{ws}/{name}", a.v1PatchLayer)
	mux.HandleFunc("PATCH /api/v1/featuretypes/{ws}/{name}", a.v1PatchFeatureType)
	mux.HandleFunc("POST /api/v1/layers/{ws}/{name}/bbox", a.v1LayerBbox)
	mux.HandleFunc("GET /api/v1/srs/{code}", a.v1SRS)
	...
	mux.HandleFunc("GET /api/v1/gwc/blobstores", a.v1BlobStores)
	mux.HandleFunc("POST /api/v1/gwc/blobstores", a.v1SaveBlobStore)
	mux.HandleFunc("DELETE /api/v1/gwc/blobstores/{name}", a.v1DeleteBlobStore)
	mux.HandleFunc("GET /api/v1/gwc/quota", a.v1GetQuota)
	mux.HandleFunc("PUT /api/v1/gwc/quota", a.v1SetQuota)
	mux.HandleFunc("GET /api/v1/gwc/layers/{ws}/{layer}", a.v1GetLayerCache)
	mux.HandleFunc("PUT /api/v1/gwc/layers/{ws}/{layer}", a.v1SaveLayerCache)
